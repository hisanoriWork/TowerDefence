...
public class ArcherPngnScript : MonoBehaviour
{
    ...
    {
       Debug.Log("アーチャーペンギンは攻撃をしました");
    }

    protected void Hurt(int damage)
    {
        Debug.Log("アーチャーペンギンは" + damage + "攻撃を受けました");
    }

    protected void Dead()
    {
        //下に死んだときの処理を描く
        Debug.Log("アーチャーペンギンはやられてしまいました");
    }
